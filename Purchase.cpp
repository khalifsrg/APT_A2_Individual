...
/// @brief Function responsible for meal purchase, receiving money and refunding change to the customer (with added help function).
/// @param foodList 
/// @param coinList 
/// @param toggle 
void Purchase::purchaseMeal(LinkedList& foodList, LinkedList& coinList, bool toggle) {
    ...
    while (displayAgain) {
        ...
        if (selectedFood == nullptr || selectedFood->on_hand <= 0) {
            ...
            continue; // Continue to prompt again if there's an error
        }
        ...
        while (remainingAmount > 0) {
            ...
            // If remaining amount is 0 or less, and there is no change, then a full refund will occur.
